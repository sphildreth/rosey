...
- **Companion (sidecar) files:** When a media file is moved, the mover will also find and move any associated companion/sidecar files (e.g., `.srt`, `.nfo`, `.jpg`) that share the same base filename.
